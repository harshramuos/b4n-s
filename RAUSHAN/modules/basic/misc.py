...
alive_logo = ALIVE_PIC or "https://graph.org/file/2cec4163a674c7e34ff0a-b917919228aff3b921.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ-𝐂ʜᴀᴛ**: [|| ˹𝗪ɪᴢᴀʀᴅ 𝗘ʀᴀᴀ ||](t.me/WIZARD_ERAA)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇs**: [𝗪𝗜𝗭𝗔𝗥𝗗](t.me/WIZARD_ERAA)\n"
        f"└• **𝐌ᴀsᴛᴇʀ**: [𝗪𝗜𝗭𝗔𝗥𝗗](t.me/wizard_pampa)"        
    )
